...
# Welcome to the Open API

The Open API allows third-party apps and services to interact with our platform, enabling features such as subscribing users to churches, sending notifications, and more. This API is designed for partners and developers who want to integrate with our ecosystem securely and efficiently.

## Authentication

All requests to the Open API require **two forms of authentication**:
...
5. **Your backend (or frontend) sends requests to the Open API, including:**
...
- [See the full list of endpoints](./endpoints)
- [Learn about error codes](./errors)
- [How to get your API key](./api-keys)
